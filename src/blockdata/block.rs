...
use hash_types::{
    BlockHash, NameTreeMerkleNode, TxMerkleNode, WitnessMerkleNode, Wtxid,
};
use hashes::{Hash};
...
mod tests {
    ...
    fn block_test() {
        // Mainnet block #5
        let some_block = Vec::from_hex("").unwrap();
        let cutoff_block = Vec::from_hex("").unwrap();
        ...
        assert_eq!(real_decode.header.difficulty(Network::Mainnet), 1);
